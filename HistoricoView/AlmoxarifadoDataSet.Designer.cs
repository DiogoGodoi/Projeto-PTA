...
namespace HistoricoView {
    ...
    public partial class AlmoxarifadoDataSet : global::System.Data.DataSet {
        ...
        public partial class historicoDataTable : global::System.Data.TypedTableBase<historicoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public historicoRow AddhistoricoRow(System.DateTime dataModificacao, string item, int quantidade, string natureza, string operador) {
...
namespace HistoricoView.AlmoxarifadoDataSetTableAdapters {
    ...
    public partial class historicoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[historico] WHERE (([codTransacao] = @Original_codTransacao) AND ((@IsNull_dataModificacao = 1 AND [dataModificacao] IS NULL) OR ([dataModificacao] = @Original_dataModificacao)) AND ([item] = @Original_item) AND ([quantidade] = @Original_quantidade) AND ([natureza] = @Original_natureza) AND ([operador] = @Original_operador))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[historico] ([dataModificacao], [item], [quantidade], [natureza], [operador]) VALUES (@dataModificacao, @item, @quantidade, @natureza, @operador);
SELECT codTransacao, dataModificacao, item, quantidade, natureza, operador FROM historico WHERE (codTransacao = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[historico] SET [dataModificacao] = @dataModificacao, [item] = @item, [quantidade] = @quantidade, [natureza] = @natureza, [operador] = @operador WHERE (([codTransacao] = @Original_codTransacao) AND ((@IsNull_dataModificacao = 1 AND [dataModificacao] IS NULL) OR ([dataModificacao] = @Original_dataModificacao)) AND ([item] = @Original_item) AND ([quantidade] = @Original_quantidade) AND ([natureza] = @Original_natureza) AND ([operador] = @Original_operador));
SELECT codTransacao, dataModificacao, item, quantidade, natureza, operador FROM historico WHERE (codTransacao = @codTransacao)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT codTransacao, dataModificacao, item, quantidade, natureza, operador FROM d" +
                "bo.historico";
        ...
        public virtual int Fill(AlmoxarifadoDataSet.historicoDataTable dataTable) {
        ...
        public virtual AlmoxarifadoDataSet.historicoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AlmoxarifadoDataSet.historicoDataTable dataTable = new AlmoxarifadoDataSet.historicoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AlmoxarifadoDataSet.historicoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_codTransacao, global::System.Nullable<global::System.DateTime> Original_dataModificacao, string Original_item, int Original_quantidade, string Original_natureza, string Original_operador) {
        ...
        public virtual int Insert(global::System.Nullable<global::System.DateTime> dataModificacao, string item, int quantidade, string natureza, string operador) {
        ...
        public virtual int Update(global::System.Nullable<global::System.DateTime> dataModificacao, string item, int quantidade, string natureza, string operador, int Original_codTransacao, global::System.Nullable<global::System.DateTime> Original_dataModificacao, string Original_item, int Original_quantidade, string Original_natureza, string Original_operador, int codTransacao) {
            if ((dataModificacao.HasValue == true)) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_codTransacao));
            if ((Original_dataModificacao.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[7].Value = ((System.DateTime)(Original_dataModificacao.Value));
            }
            else {
            ...
            if ((Original_natureza == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_natureza));
            }
            if ((Original_operador == null)) {
                throw new global::System.ArgumentNullException("Original_operador");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_operador));
            }
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(codTransacao));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<global::System.DateTime> dataModificacao, string item, int quantidade, string natureza, string operador, int Original_codTransacao, global::System.Nullable<global::System.DateTime> Original_dataModificacao, string Original_item, int Original_quantidade, string Original_natureza, string Original_operador) {
            return this.Update(dataModificacao, item, quantidade, natureza, operador, Original_codTransacao, Original_dataModificacao, Original_item, Original_quantidade, Original_natureza, Original_operador, Original_codTransacao);
        }
    }
